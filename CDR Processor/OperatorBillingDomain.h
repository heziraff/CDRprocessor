...
public:
	...
	OperatorBillingDomain(const OperatorBillingDomain& a_other) = default;
	~OperatorBillingDomain() = default;
	OperatorBillingDomain& operator=(const OperatorBillingDomain& a_other) = default;
